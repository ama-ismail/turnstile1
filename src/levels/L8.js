...
export default function L8(props) {
    ...
    function correctMove2(num, way){
      if((num === 0 && way === "R" && support1[0] === 1) || (num === 1 && way === "D" && support1[1] === 1)
       || (num === 4 && way === "L" && support1[2] === 1) || (num === 3 && way === "U" && support1[3] === 1)){
        if(support1[0] === 1 && (gray1[1] === 1 || gray2[1] === 1 || gray3[1] === 1 || green[1] === 1 || orange[1] === 1 || blue[1] === 1 || purple[1] === 1) && num !== 1){
          allow = 0;
        } else if(support1[1] === 1 && (gray1[4] === 1 || gray2[4] === 1 || gray3[4] === 1 || green[4] === 1 || orange[4] === 1 || blue[4] === 1 || purple[4] === 1) && num !== 4){
          allow = 0;
        } else if(support1[2] === 1 && (gray1[3] === 1 || gray2[3] === 1 || gray3[3] === 1 || green[3] === 1 || orange[3] === 1 || blue[3] === 1 || purple[3] === 1) && num !== 3){
          allow = 0;
        } else if(support1[3] === 1 && (gray1[0] === 1 || gray2[0] === 1 || gray3[0] === 1 || green[0] === 1 || orange[0] === 1 || blue[0] === 1 || purple[0] === 1) && num !== 0){
          allow = 0;
        }
      }
      if((num === 0 && way === "D" && support1[3] === 1) || (num === 1 && way === "L" && support1[0] === 1)
      || (num === 4 && way === "U" && support1[1] === 1) || (num === 3 && way === "R" && support1[2] === 1)){
        if(support1[1] === 1 && (gray1[1] === 1 || gray2[1] === 1 || gray3[1] === 1 || green[1] === 1 || orange[1] === 1 || blue[1] === 1 || purple[1] === 1) && num !== 1){
          allow = 0;
        } else if(support1[2] === 1 && (gray1[4] === 1 || gray2[4] === 1 || gray3[4] === 1 || green[4] === 1 || orange[4] === 1 || blue[4] === 1 || purple[4] === 1) && num !== 4){
          allow = 0;
        } else if(support1[3] === 1 && (gray1[3] === 1 || gray2[3] === 1 || gray3[3] === 1 || green[3] === 1 || orange[3] === 1 || blue[3] === 1 || purple[3] === 1) && num !== 3){
          allow = 0;
        } else if(support1[0] === 1 && (gray1[0] === 1 || gray2[0] === 1 || gray3[0] === 1 || green[0] === 1 || orange[0] === 1 || blue[0] === 1 || purple[0] === 1) && num !== 0){
          allow = 0;
        }
      }
      if((num === 1 && way === "R" && support2[0] === 1) || (num === 2 && way === "D" && support2[1] === 1)
      || (num === 5 && way === "L" && support2[2] === 1) || (num === 4 && way === "U" && support2[3] === 1)){
        if(support2[0] === 1 && (gray1[2] === 1 || gray2[2] === 1 || gray3[2] === 1 || green[2] === 1 || orange[2] === 1 || blue[2] === 1 || purple[2] === 1) && num !== 2){
          allow = 0;
        } else if(support2[1] === 1 && (gray1[5] === 1 || gray2[5] === 1 || gray3[5] === 1 || green[5] === 1 || orange[5] === 1 || blue[5] === 1 || purple[5] === 1) && num !== 5){
          allow = 0;
        } else if(support2[2] === 1 && (gray1[4] === 1 || gray2[4] === 1 || gray3[4] === 1 || green[4] === 1 || orange[4] === 1 || blue[4] === 1 || purple[4] === 1) && num !== 4){
          allow = 0;
        } else if(support2[3] === 1 && (gray1[1] === 1 || gray2[1] === 1 || gray3[1] === 1 || green[1] === 1 || orange[1] === 1 || blue[1] === 1 || purple[1] === 1) && num !== 1){
          allow = 0;
        }
      }
      if((num === 1 && way === "D" && support2[3] === 1) || (num === 2 && way === "L" && support2[0] === 1)
      || (num === 5 && way === "U" && support2[1] === 1) || (num === 4 && way === "R" && support2[2] === 1)){
        if(support2[1] === 1 && (gray1[2] === 1 || gray2[2] === 1 || gray3[2] === 1 || green[2] === 1 || orange[2] === 1 || blue[2] === 1 || purple[2] === 1) && num !== 2){
          allow = 0;
        } else if(support2[2] === 1 && (gray1[5] === 1 || gray2[5] === 1 || gray3[5] === 1 || green[5] === 1 || orange[5] === 1 || blue[5] === 1 || purple[5] === 1) && num !== 5){
          allow = 0;
        } else if(support2[3] === 1 && (gray1[4] === 1 || gray2[4] === 1 || gray3[4] === 1 || green[4] === 1 || orange[4] === 1 || blue[4] === 1 || purple[4] === 1) && num !== 4){
          allow = 0;
        } else if(support2[0] === 1 && (gray1[1] === 1 || gray2[1] === 1 || gray3[1] === 1 || green[1] === 1 || orange[1] === 1 || blue[1] === 1 || purple[1] === 1) && num !== 1){
          allow = 0;
        }
      }
      if((num === 3 && way === "R" && support3[0] === 1) || (num === 4 && way === "D" && support3[1] === 1)
      || (num === 7 && way === "L" && support3[2] === 1) || (num === 6 && way === "U" && support3[3] === 1)){
        if(support3[0] === 1 && (gray1[4] === 1 || gray2[4] === 1 || gray3[4] === 1 || green[4] === 1 || orange[4] === 1 || blue[4] === 1 || purple[4] === 1) && num !== 4){
          allow = 0;
        } else if(support3[1] === 1 && (gray1[7] === 1 || gray2[7] === 1 || gray3[7] === 1 || green[7] === 1 || orange[7] === 1 || blue[7] === 1 || purple[7] === 1) && num !== 7){
          allow = 0;
        } else if(support3[2] === 1 && (gray1[6] === 1 || gray2[6] === 1 || gray3[6] === 1 || green[6] === 1 || orange[6] === 1 || blue[6] === 1 || purple[6] === 1) && num !== 6){
          allow = 0;
        } else if(support3[3] === 1 && (gray1[3] === 1 || gray2[3] === 1 || gray3[3] === 1 || green[3] === 1 || orange[3] === 1 || blue[3] === 1 || purple[3] === 1) && num !== 3){
          allow = 0;
        }
      }
      if((num === 3 && way === "D" && support3[3] === 1) || (num === 4 && way === "L" && support3[0] === 1)
      || (num === 7 && way === "U" && support3[1] === 1) || (num === 6 && way === "R" && support3[2] === 1)){
        if(support3[1] === 1 && (gray1[4] === 1 || gray2[4] === 1 || gray3[4] === 1 || green[4] === 1 || orange[4] === 1 || blue[4] === 1 || purple[4] === 1) && num !== 4){
          allow = 0;
        } else if(support3[2] === 1 && (gray1[7] === 1 || gray2[7] === 1 || gray3[7] === 1 || green[7] === 1 || orange[7] === 1 || blue[7] === 1 || purple[7] === 1) && num !== 7){
          allow = 0;
        } else if(support3[3] === 1 && (gray1[6] === 1 || gray2[6] === 1 || gray3[6] === 1 || green[6] === 1 || orange[6] === 1 || blue[6] === 1 || purple[6] === 1) && num !== 6){
          allow = 0;
        } else if(support3[0] === 1 && (gray1[3] === 1 || gray2[3] === 1 || gray3[3] === 1 || green[3] === 1 || orange[3] === 1 || blue[3] === 1 || purple[3] === 1) && num !== 3){
          allow = 0;
        }
      }
      if((num === 4 && way === "R" && support4[0] === 1) || (num === 5 && way === "D" && support4[1] === 1)
      || (num === 8 && way === "L" && support4[2] === 1) || (num === 7 && way === "U" && support4[3] === 1)){
        if(support4[0] === 1 && (gray1[5] === 1 || gray2[5] === 1 || gray3[5] === 1 || green[5] === 1 || orange[5] === 1 || blue[5] === 1 || purple[5] === 1) && num !== 5){
          allow = 0;
        } else if(support4[1] === 1 && (gray1[8] === 1 || gray2[8] === 1 || gray3[8] === 1 || green[8] === 1 || orange[8] === 1 || blue[8] === 1 || purple[8] === 1) && num !== 8){
          allow = 0;
        } else if(support4[2] === 1 && (gray1[7] === 1 || gray2[7] === 1 || gray3[7] === 1 || green[7] === 1 || orange[7] === 1 || blue[7] === 1 || purple[7] === 1) && num !== 7){
          allow = 0;
        } else if(support4[3] === 1 && (gray1[4] === 1 || gray2[4] === 1 || gray3[4] === 1 || green[4] === 1 || orange[4] === 1 || blue[4] === 1 || purple[4] === 1) && num !== 4){
          allow = 0;
        }
      }
      if((num === 4 && way === "D" && support4[3] === 1) || (num === 5 && way === "L" && support4[0] === 1)
      || (num === 8 && way === "U" && support4[1] === 1) || (num === 7 && way === "R" && support4[2] === 1)){
        if(support4[1] === 1 && (gray1[5] === 1 || gray2[5] === 1 || gray3[5] === 1 || green[5] === 1 || orange[5] === 1 || blue[5] === 1 || purple[5] === 1) && num !== 5){
          allow = 0;
        } else if(support4[2] === 1 && (gray1[8] === 1 || gray2[8] === 1 || gray3[8] === 1 || green[8] === 1 || orange[8] === 1 || blue[8] === 1 || purple[8] === 1) && num !== 8){
          allow = 0;
        } else if(support4[3] === 1 && (gray1[7] === 1 || gray2[7] === 1 || gray3[7] === 1 || green[7] === 1 || orange[7] === 1 || blue[7] === 1 || purple[7] === 1) && num !== 7){
          allow = 0;
        } else if(support4[0] === 1 && (gray1[4] === 1 || gray2[4] === 1 || gray3[4] === 1 || green[4] === 1 || orange[4] === 1 || blue[4] === 1 || purple[4] === 1) && num !== 4){
          allow = 0;
        }
      }
    }
    ...
    $(document).keyup(function(e){
      ...
      if(chip === 1 && bluePos !== -1){
        if(purple[bluePos - 1] === 0 && orange[bluePos - 1] === 0 && green[bluePos - 1] === 0
          && gray1[bluePos - 1] === 0 && gray2[bluePos - 1] === 0 && gray3[bluePos - 1] === 0
          ...
          && gray1[bluePos - 3] === 0 && gray2[bluePos - 3] === 0 && gray3[bluePos - 3] === 0
        ...
        if(blue[purplePos - 1] === 0 && orange[purplePos - 1] === 0 && green[purplePos - 1] === 0
          && gray1[purplePos - 1] === 0 && gray2[purplePos - 1] === 0 && gray3[purplePos - 1] === 0
          ...
          && gray1[purplePos - 3] === 0 && gray2[purplePos - 3] === 0 && gray3[purplePos - 3] === 0
        ...
        if(blue[orangePos - 1] === 0 && purple[orangePos - 1] === 0 && green[orangePos - 1] === 0
          && gray1[orangePos - 1] === 0 && gray2[orangePos - 1] === 0 && gray3[orangePos - 1] === 0
          ...
          && gray1[orangePos - 3] === 0 && gray2[orangePos - 3] === 0 && gray3[orangePos - 3] === 0
        ...
        if(blue[greenPos - 1] === 0 && purple[greenPos - 1] === 0 && orange[greenPos - 1] === 0
          && gray1[greenPos - 1] === 0 && gray2[greenPos - 1] === 0 && gray3[greenPos - 1] === 0
          ...
          && gray1[greenPos - 3] === 0 && gray2[greenPos - 3] === 0 && gray3[greenPos - 3] === 0
        ...
        if(blue[gray1Pos - 1] === 0 && purple[gray1Pos - 1] === 0 && orange[gray1Pos - 1] === 0
          && green[gray1Pos - 1] === 0 && gray2[gray1Pos - 1] === 0 && gray3[gray1Pos - 1] === 0
          ...
          && green[gray1Pos - 3] === 0 && gray2[gray1Pos - 3] === 0 && gray3[gray1Pos - 3] === 0
        ...
        if(blue[gray2Pos - 1] === 0 && purple[gray2Pos - 1] === 0 && orange[gray2Pos - 1] === 0
          && green[gray2Pos - 1] === 0 && gray1[gray2Pos - 1] === 0 && gray3[gray2Pos - 1] === 0
          ...
          && green[gray2Pos - 3] === 0 && gray1[gray2Pos - 3] === 0 && gray3[gray2Pos - 3] === 0
        ...
        if(blue[gray3Pos - 1] === 0 && purple[gray3Pos - 1] === 0 && orange[gray3Pos - 1] === 0
          && green[gray3Pos - 1] === 0 && gray1[gray3Pos - 1] === 0 && gray2[gray3Pos - 1] === 0
          ...
          && green[gray3Pos - 3] === 0 && gray1[gray3Pos - 3] === 0 && gray2[gray3Pos - 3] === 0
