    ...
    <div className="container">
      ...
      <div className="field1">
        ...
        <div className="field2">
          <div className="circle1" style={{fontSize: "14px"}}></div>
          <div className="circle2" style={{fontSize: "14px"}}></div>
          <div className="circle3" style={{fontSize: "14px"}}></div>
          <div className="circle4" style={{fontSize: "14px"}}></div>
          <div className="circle5" style={{fontSize: "14px"}}></div>
          <div className="circle6" style={{fontSize: "14px"}}></div>
          <div className="circle7" style={{fontSize: "14px"}}></div>
          <div className="circle8" style={{fontSize: "14px"}}></div>
          <div className="circle9" style={{fontSize: "14px"}}></div>
